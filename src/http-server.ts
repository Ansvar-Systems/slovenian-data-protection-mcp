...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across IP RS (Informacijski pooblaščenec) decisions and sanctions.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Search query (e.g., 'piškotki', 'nadzor zaposlenih')" },
        type: {
          type: "string",
  ...
  },
  {
    ...
    description:
      "Search IP RS guidance documents on GDPR implementation in Slovenia.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "Get a specific IP RS guidance document by its database ID.",
    inputSchema: {
      type: "object" as const,
      properties: {
  ...
  },
  {
    ...
    description: "List all covered data protection topics with Slovenian and English names.",
      ...
      switch (name) {
        ...
        case "si_dp_about": {
          return textContent({
            name: SERVER_NAME,
            version: pkgVersion,
            description: "IP RS (Informacijski pooblaščenec) MCP server. Provides access to Slovenian data protection authority decisions and guidance.",
